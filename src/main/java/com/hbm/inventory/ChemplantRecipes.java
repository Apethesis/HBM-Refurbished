...
public class ChemplantRecipes {
	...
	public static void registerRecipes() {
		...
		makeRecipe(570, "YELLOWCAKE", new AStack[] { new OreDictStack(U.billet(), 2), new OreDictStack(S.dust(), 2) }, new FluidStack[]{ new FluidStack(ModForgeFluids.acid, 500) }, new AStack[] { new ComparableStack(ModItems.powder_yellowcake, 1) }, null, 250);

		makeRecipe(580, "UF6", new AStack[] { new ComparableStack(ModItems.powder_yellowcake, 1), new OreDictStack(F.dust(), 4) }, new FluidStack[]{ new FluidStack(FluidRegistry.WATER, 1000) }, new AStack[] { new ComparableStack(ModItems.sulfur, 2) }, new FluidStack[]{ new FluidStack(ModForgeFluids.uf6, 1200) }, 100);

		makeRecipe(590, "PUF6", new AStack[] { new OreDictStack(PU.dust(), 1), new OreDictStack(F.dust(), 3) }, new FluidStack[]{ new FluidStack(FluidRegistry.WATER, 1000) }, null, new FluidStack[]{ new FluidStack(ModForgeFluids.puf6, 900) }, 150);
